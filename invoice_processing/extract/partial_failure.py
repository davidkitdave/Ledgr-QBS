"""G5 partial-failure semantics for multi-document extraction (WS-2.5).

When some documents reconcile and others do not, or page coverage suggests
missing documents, deliver every extracted document and surface loud warnings
on the delivery payload — never silently drop good rows.
"""
