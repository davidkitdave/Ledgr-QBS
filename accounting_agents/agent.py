...
# Playground-context helpers — canonical definitions live in the neutral
# shared module so that ledgr_agent can import them without depending on
# accounting_agents.  Re-exported here for backward compatibility.
from invoice_processing.shared_libraries.playground_context import (
    playground_default_context,
    seed_playground_profile_if_needed,
)

from . import config  # noqa: F401 — ensures AI Studio env is set before any ADK model init
from . import nodes
...
# Private-name alias preserved for any internal / test callers.
_playground_default_context = playground_default_context
