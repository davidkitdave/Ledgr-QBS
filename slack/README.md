...
| `manifest-dev.json` | "Ledgr (dev)" Slack app for local socket-mode testing. Install in your developer workspace (LEDGR-DEV) only. **Never** install in a customer workspace. |
